...
static const casadi_int casadi_s4[9] = {5, 2, 0, 2, 4, 2, 3, 2, 3};
static const casadi_int casadi_s5[12] = {5, 5, 0, 0, 0, 2, 4, 4, 2, 3, 2, 3};
static const casadi_int casadi_s6[3] = {2, 0, 0};

/* car_model_constr_h_fun_jac_uxt_zt_hess:(i0[3],i1[2],i2[2],i3[],i4[4])->(o0[2],o1[5x2,4nz],o2[5x5,4nz],o3[2x0],o4[]) */
